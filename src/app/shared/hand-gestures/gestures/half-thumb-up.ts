...
HALF_THUMB_UP_GESTURE.addCurl(Finger.Thumb, FingerCurl.NoCurl, 0.6);
HALF_THUMB_UP_GESTURE.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 0.6);
HALF_THUMB_UP_GESTURE.addCurl(Finger.Thumb, FingerCurl.FullCurl, 0.6);
